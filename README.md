...
- [Download the iOS 0.1.18 native setup Continue fix unsigned IPA](https://github.com/Csiklaoliver/speedtest-plus-docs/releases/download/ios-v0.1.18-native-setup-continue-fix/SpeedtestPlus-iOS-0.1.18-native-setup-continue-fix-unsigned.ipa)
